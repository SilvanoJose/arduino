...
void setup() {
  ...
  Serial1.begin(57600); // Inicia a comunicação serial com o sensor de digitais
...
void setupFingerprintSensor() {
  ...
  if (!fingerprintSensor.verifyPassword()) {
    // Se chegou aqui significa que a senha está errada ou o sensor está com problemas de conexão
